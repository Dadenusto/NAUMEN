    ...
    static char[][] findRoute(char[][] map) {
        ...
        do{
            ...
            for (int k = 0; k<arr_length;k+=2) {
                ...
                if (new_map[i][j] == d) {
                    if (i - 1 >= 0 && way2 == -1) {
                        // если она не имеет значение, записываем в нее значение на 1 больше, а в массив для следующих точек заносим координаты
            ...
            // увеличиваем d и переходим к точкам, в которых значение-увеличенное d
            arr = new_arr;
